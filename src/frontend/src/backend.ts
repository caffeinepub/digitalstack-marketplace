...
import type { ExternalBlob as _ExternalBlob, Product as _Product, ProductDTO as _ProductDTO, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCashfreePaymentLink(arg0: bigint, arg1: bigint, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createCashfreePaymentLink(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: Array<bigint>, arg1: bigint, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllProductsByCategory(arg0: string): Promise<Array<ProductDTO>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProductsByCategory(arg0);
    ...
    async getDownloadUrl(arg0: bigint, arg1: bigint): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDownloadUrl(arg0, arg1);
    ...
    async getFeaturedProducts(): Promise<Array<ProductDTO>> {
        if (this.processError) {
            try {
    ...
    async getMyOrders(): Promise<Array<OrderDTO>> {
        if (this.processError) {
            try {
    ...
    async getOrder(arg0: bigint): Promise<OrderDTO> {
        if (this.processError) {
            try {
    ...
    async getProduct(arg0: bigint): Promise<ProductDTO> {
        if (this.processError) {
            try {
                const result = await this.actor.getProduct(arg0);
                return from_candid_ProductDTO_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getTopSellers(arg0: bigint): Promise<Array<ProductDTO>> {
        if (this.processError) {
            try {
    ...
    async searchProducts(arg0: string, arg1: string): Promise<Array<ProductDTO>> {
        if (this.processError) {
            try {
    ...
    async verifyPaymentStatus(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyPaymentStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ProductDTO_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductDTO): ProductDTO {
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        priceInPaise: value.priceInPaise,
        ...
        fileUrl: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.fileUrl))
    };
}
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductDTO>): Array<ProductDTO> {
    return value.map((x)=>from_candid_ProductDTO_n14(_uploadFile, _downloadFile, x));
}
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: value.category,
        salesCount: value.salesCount,
        fileUrl: await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.fileUrl)
    };
}
